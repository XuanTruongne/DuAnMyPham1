        ...
        <div class="row">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 10px;">
                        <div class="carousel-item active" >
                            <img class="img-fluid" src="public/img/banner-11.png" alt="Image">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="public/img/banner-SALE.png" alt="Image">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="public/img/banner_index_customer.jpg" alt="Image">
            ...
            <div class="col-lg-4">
                <div class="product-offer" >
                    <img class="img-fluid" src="public/img/banner_index_customer.jpg" alt="">
...
<!-- Banner Section Begin -->
<section class="banner set-bg" data-setbg="public/img/banner_index_customer.jpg">
    <div class="container">
        <div class="row">

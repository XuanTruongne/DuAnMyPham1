<body>
    ...
    <header class="header" style="background-image: url('public/img/banner/backgr-glonav.png'); width: 1515px; height: 100px">
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-2">
                    <img style="height: 100px" src="public/img/logo-pureluxe.png" alt=""></a>
                </div>
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            <li ><a href="index.php" style="font-size: 20px">TRANG CHỦ</a></li>                          
